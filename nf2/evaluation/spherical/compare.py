...
cartesian_out = cartesian_model.load_cube(progress=True, Mm_per_pixel=Mm_per_pixel)
...
spherical_model = SphericalOutput('/glade/work/rjarolim/nf2/spherical/377_v03/extrapolation_result.nf2')
...
subframe_model = SphericalOutput('/glade/work/rjarolim/nf2/spherical/377_subframe_v03/extrapolation_result.nf2')
...
spherical_coords = all_coordinates_from_map(reference_map)
#
...
print(f'Divergence: Cartesian: {div_cartesian:.2e}, Spherical:  {div_spherical:.2e}, Subframe: {div_subframe:.2e}')
print(f'Weighted Theta:  Cartesian: {theta_cartesian:.2f}, Spherical: {theta_spherical:.2f}, Subframe: {theta_subframe:.2f}')
print(f'B Diff: Cartesian: {b_diff_cartesian:.2f}, Spherical: {b_diff_spherical:.2f}, Subframe: {b_diff_subframe:.2f}')
print(f'B Diff Err: Cartesian: {b_diff_err_cartesian:.2f}, Spherical: {b_diff_err_spherical:.2f}, Subframe: {b_diff_err_subframe:.2f}')
