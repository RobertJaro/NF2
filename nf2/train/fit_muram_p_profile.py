...
from nf2.data.read_muram import MURaMSimulation
...
muram_simulation = MURaMSimulation(args.muram_source_path)

snapshot = muram_simulation.get_iteration(args.iteration)
...
muram_p = snapshot.Pres #u.G ** 2 * u.cm ** 2

gauss_per_dB = 2500
meters_per_ds = .36 * 320 * 1e6
...
coords =  coords * (Mm_per_pixel * 1e6 / meters_per_ds)
